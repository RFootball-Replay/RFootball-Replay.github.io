...
(function (qc) {
  ...
  kb.N = '<div class=\'choose-nickname-view\'><img src="https://rfootball-replay.github.io/images/falafcio.png" /><div class=\'dialog\'><h4>R.Football Replay</h4><div style=\'display: none\' class=\'label-input\'><label>Nick:</label><input data-hook=\'input\' type=\'text\' /></div><button id=\'button_ok\' data-hook=\'ok\'>Start</button></div></div>';
